...
public class CategoryService {
    ...
    //Retrive all the categories for the current user
    public List<CategoryDTO> getCategoriesForCurrentUser(){
        ...
        //Retrive categories by type for the current user
    ...
    // Update the existing category and ensure it belongs to the current user
