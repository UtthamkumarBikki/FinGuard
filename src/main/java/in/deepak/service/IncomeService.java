...
import in.deepak.repository.IncomeRepository;
...
public class IncomeService {
    ...
    //Add a new income for the current user into the database
    ...
    //Retrive the Incomes for the Current Month or Based on the start date and end date
