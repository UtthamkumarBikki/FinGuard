    ...
    public void sendDailyIncomeExpenseRemainder() {
        ...
        for (ProfileEntity profile : profiles) {
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    ...
                    + "<a href=" + frontendUrl + " style=display:inline-block;padding:10x 20px;background-color:#4CAF50;color:#fff;text-decoration:none;border-radius:5px;font-weight:bold;'>Go to ExpenseIQ</a>"
